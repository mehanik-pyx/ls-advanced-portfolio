<template>
  <div class="v_slider">
    <div class="reviews__top-wrapper">
      <h2 class="section-title section-title_no-margin">Что обо мне говорят</h2>
      <div class="buttons">
...
<script>
  console.log('this is slider.vue module');
  export default {
    name: 'slider',
    props: {
...
<style>
  ...
  .v_slider__list { width: 100%; min-height: 1px; float: left; display: block; position: relative; margin-top: 88px; }
  ...
  .v_slider__item { float: left; -webkit-backface-visibility: hidden; -webkit-touch-callout: none; }
